...
selectn3 + " " + selectn4 + " " + selectn5;
	  ...
	  num++;
      unlocklog.push("第"+ num +"次选择的数字： #b" + selectn1 + selectn2 + selectn3 + selectn4 + selectn5 +"     #r" + postrue + "★  " + seltrue + "☆#k\r\n");
      str_unlocklog = "";
      ...
      if (postrue == 5) {
		...
		cm.给金币(取随机数(1000000,3000000));
		cm.喇叭(2,"玩家 "+cm.getPlayer().getName()+" 在豆豆屋 解锁保险箱密码 成功通关，大家恭喜他/她吧~~")
      } else {
        unlock -= 1;
        if (unlock >= 0)
          a = 1;
