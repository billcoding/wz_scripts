...
function action(mode, type, selection) {
	...
	if (cm.isLeader()) { // Leader
		...
		if (cm.haveItem(4001022, 11)) { // Clear stage
		    ...
		    cm.sendNext("你确定你有收集了 #r11张 #t4001022##k？？");
		}
		cm.dispose();
	    } else {
		cm.sendOk("欢迎来到第二阶段。#b玩具塔101组队#k 请收集#r#t4001022##k 来找我即可完成任务。");
		eim.setProperty("stage2leader","done");
		cm.dispose();
	    }
	} else { // Members
	    cm.sendNext("欢迎来到第二阶段。#b玩具塔101组队#k 请收集#r#t4001022##k 给你的队长，然后叫队长来找我即可完成任务。");
	    cm.dispose();
	}
    } else {
	cm.sendNext("恭喜！你已经通过了第二阶段。快点现在，到第三阶段。");
