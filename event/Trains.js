...
function scheduleNew() {
    ...
    Ludibrium_Station.broadcastMessage(tools.MaplePacketCreator.boatPacket(true));
...
function takeoff() {
    ...
    Ludibrium_Station.broadcastMessage(tools.MaplePacketCreator.boatPacket(false));
