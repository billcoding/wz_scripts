	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			qm.dispose();
                        ...
                        qm.sendNext("恭喜你当前等级已经到达#b10#k级，即将获得本服#e#r GM #n#k赠送的 #b工作人员套装 #k和 #b强化卷轴#k !(装备栏至少留6个位置)");
			}
		} else if (status == 1) {
			qm.sendOk("恭喜你获得系统奖励！\r\n\r\n#fUI/UIWindow.img/QuestIcon/4/0#\r\n#v1002797# #v1102174# #v1052165# #v1072366# #v1082244# #v1032058# #v2049104#x30");
